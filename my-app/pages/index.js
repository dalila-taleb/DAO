          ...
          {proposals.map((p, index) => (
            <div key={index} className={styles.proposalCard}>
              ...
              {p.deadline.getTime() > Date.now() && !p.executed ? (
                ...
                <div className={styles.description2}>Proposal Executed</div>
              )}
            </div>
          ))}
        </div>
  ...
  return (
    <div className={styles.container}>
      ...
      <div className={styles.main}>
        <div>
          <h1 className={styles.title}>Welcome to the DAO from Crypto Devs!</h1>
          <div className={styles.description}>
        ...
        <div>
          <img className={styles.image} src="/crypto-nft/img.png" />
        </div>
      </div>
